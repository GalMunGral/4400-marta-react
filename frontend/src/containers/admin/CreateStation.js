    ...
    if (
      ...
      if (stationInfo.fare < 0 || stationInfo.fare > 50) {
        this.props.showErrorMessage(
          "Fare must be between $0 and $50! Time: " + new Date(),
          1
        );
        return;
      }
      if (isBusStation && !isTrainStation) {
        ...
        this.props.showErrorMessage(
          "You must select either bus or train! Time:" + new Date,
          1
        );
        return;
      }
            ...
            <Form horizontal className="container-fluid">
              ...
              <FormGroup>
                ...
                <Col sm={10} md={8}>
                  <Radio
                    ...
                    inputRef={ref => { this.createBusStationRadio = ref; }}
                    onClick={() => {
                  ...
                  <Radio
                    name="selectStationType"
                    inputRef={ref => { this.createTrainStationRadio = ref; }}
                    onClick={() => {this.intersectionInput.disabled = true;}}
                  >
                    Train Station
                  </Radio>
                </Col>
              ...
              <FormGroup>
                <Col mdOffset={3} md={10}>
                  <Checkbox
                    inputRef={ref => { this.openStationCheckbox = ref; }}
                  >
                    Open Station
                  </Checkbox>
                  <HelpBlock>
