...
import {
  ...
  completeTrip,
  reset
} from '../../actions/passenger/currentTrip';
...
class Trip extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    if (
      nextProps.startStationIndex !== null
      ...
      currentTrip.breezecardNum = (
        nextProps.cards[nextProps.selected].BreezecardNum
      );
      ...
      <SlimCol>
        ...
        <Panel>
            ...
            <Form horizontal className="container-fluid">
              <FormGroup>
                ...
                <Col md={4}>
                  <Button
                    block
                    onClick={() => { this.props.history.push('/my-cards'); }}
                  >
                    Manage Cards
                  </Button>
                </Col>
              ...
              <FormGroup>
                <Col componentClass={ControlLabel} md={3}>Balance</Col>
                <Col
              ...
              <FormGroup>
                <Col componentClass={ControlLabel} sm={2} md={3}>Start At</Col>
                <Col md={5}>
                  {this.props.currentTrip.startStationIndex === null ? (
                    <FormControl
                      componentClass="select"
                    ...
                    <ControlLabel>
                      {this.props.stations[
                        this.props.currentTrip.startStationIndex
                      ].Name}
                    </ControlLabel>
                  )}
                </Col>
              ...
              <FormGroup>
                <Col componentClass={ControlLabel} sm={2} md={3}>Ending At</Col>
                <Col md={5}>
                  {this.props.currentTrip.endStationIndex === null ? (
                    <FormControl
                      componentClass="select"
                    ...
                    <ControlLabel>
                      {this.props.stations[
                        this.props.currentTrip.endStationIndex
                      ].Name}
                    </ControlLabel>
                  )}
                </Col>
          ...
          <Col md={4}>
            <Button
              block
              onClick={() => { this.props.history.push('/trip-history'); }}
            >
              View Trip History
            </Button>
          </Col>
