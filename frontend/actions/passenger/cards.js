...
export function removeCard(cardInfo) {
    return (dispatch) => {
        ...
        return fetch('/api/passenger/remove-card', {
            method: 'POST',
...
export function fetchMyCards(user, order) {
    return (dispatch) => {
        ...
        return fetch(`/api/passenger/my-cards?user=${user}&attr=${attr}&asc=${asc}`)
