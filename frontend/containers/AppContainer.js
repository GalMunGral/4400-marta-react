        ...
        <Router history={history}>
            <div>
                ...
                <div style={{marginTop: "60px"}}>
                    ...
                    <Route path="/registration" render={() => <Registration history={history}/>}/>
                    <Route path="/admin-dashboard" render={() => <AdminDashboard history={history}/>}/>
                    <Route exact path="/stations" component={Stations}/>
                    <Route path="/station-detail/:station" render={() => <StationDetail history={history}/>}/>
                    <Route path="/create-new-station" render={() => (<CreateStation history={history}/>)}/>
